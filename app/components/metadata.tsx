...
interface HomeHeroProps {
  /** Anchor ID for the “Browse posts” button */
  postsAnchorId?: string;
}

const HomeHero: FC<HomeHeroProps> = ({ postsAnchorId = 'posts' }) => (
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-2xl space-y-4">
          ...
          <p className="text-lg text-blue-50">
            Fast, secure, and delightful by default. Search, filter, and explore stories with a
            fully featured experience built on Next.js 14 and Supabase.
          </p>
          <div className="flex flex-wrap items-center gap-3">
            <a
              href={`#${postsAnchorId}`}
              className="inline-flex items-center justify-center rounded-lg bg-white px-5 py-3 text-sm font-semibold text-blue-700 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600"
            >
              Browse posts
            </a>
            <a
